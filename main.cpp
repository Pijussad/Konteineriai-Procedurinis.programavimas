...
int main() {
  ...
  do{
    cin >> pasirinkimas;
    if (pasirinkimas != '1' && pasirinkimas != '2') cout << "Prasošome pasirinkti 1 arba 2:  ";
  ...
  if (pasirinkimas == '1') {
    ...
    do {
     ...
     studentai.push_back(Studentas());
        ...
        fd >> studentai.back().egz; // add missing semicolon
        //studentai.back().paz.pop_back();
        n++;
  } while (!fd.eof());
